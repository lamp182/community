...
<div id="content" class="clearfix content-comm content-mmgl">
        	<div class="con-in pw-management" id="reg-page">            	
                ...
                <div class="main">
                	<!--form-->
                    <!-- js-validateMe -->
                    <form class="form-pw-reset " data-showmsg="true" method="post"  action="{{url('/home/default/dophyan')}}" novalidate="novalidate">
                       {{ csrf_field() }}
                        <p class="account">
                        	<label for="account">帐号：</label>
                            <span class="account-txt">{{ $phon }}</span>
                        </p>
                        <p class="pw">
                        	<label for="pw">新密码：</label>
                             <!-- data-indicator="pwindicator" -->
                            <input type="password" autocomplete="off" class="input-txt input-pw" id="pw" name="password" maxlength="20">
                            <span id="span"></span>
                                 <ul  class="ul">
                                            <li class='li'>弱</li>
                                            <li class='li'>中</li>
                        ...
                        <input type="hidden" name="phone" value="{{$phon}}">
                        <p class="box-btn"><button class="btn btn-submit" id="but" type="submit"><span>提交</span></button></p>
						<!-- <input type="hidden" name="_random_license" value="c9b49d33044689137c8c44ab81d57e4c252d9655"> -->
                    </form>
                    <script>
                              ...
                              $('#pw').blur(function(){
                                ...
                                if(param1.length > '6' && param1 != ''){
                                      $('#span').html("<font color='green'>恭喜!密码可用</font>");
                                       time=true; 
                                }else{
                                     $('#span').html("<font color='red'>密码不可用或不可为空</font>");
