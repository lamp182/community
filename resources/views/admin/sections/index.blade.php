...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">板块列表</div>
                                            ...
                                            <tr class="even gradeC">
                                                ...
                                                <td class="am-text-middle">
                                                    <div class="tpl-table-black-operation">
                                                        <a href="{{url('admin/sections/'.$vv->id).'/edit'}}">
                                    ...
                                    <script>
                                        $(function(){
                                            $('#option').change(function(){
                                                ...
                                                location.href = "{{url('admin/select?value=')}}"+value;
                                             ...
                                             $('.shanchu').click(function(){
                                                var s = $(this).attr('id');
                                                // console.log(s);
                                                $.post("{{url('admin/sections')}}/"+s,{'_method':'DELETE','_token':"{{csrf_token()}}"},function(msg){
                                                    if(msg == '删除成功'){
                                                        alert(msg);
