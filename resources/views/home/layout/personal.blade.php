...
//                     .width(70);
//             } else {
//                 J('<a href="' + url + '" class="y app-download-btn" style="width: 70px;float:left;">手机版 <img style="position:relative; top:3px;" src="../../../public/home/picture/icon_phone_2_1.png"></a>').prependTo('#bnav, .chart-bar');
//             }
//         }
//     }()
// </script> 
